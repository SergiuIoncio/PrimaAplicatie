...
public class DeleteUser {
        ...
        @FindBy(xpath = "/html/body/app-root/app-users/app-user-card[1]/div/div[7]/button[2]")
        private WebElement DeleteButton;
        @FindBy(xpath = "/html/body/app-root/app-users/div[2]/app-deletemodal/div/div/button[1]/span[1]")
        private WebElement CancelButtonElement;
        @FindBy(xpath = "/html/body/app-root/app-users/div[2]/app-deletemodal/div/div/button[2]/span[1]")
        private WebElement YesButtonElement;
        @FindBy(xpath = "/html/body/app-root/app-users/app-header/mat-toolbar/div/button")
